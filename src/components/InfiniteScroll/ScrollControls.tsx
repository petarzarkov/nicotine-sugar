...
export function ScrollControls({
  ...
  React.useEffect(() => {
    ...
    raycaster.computeOffsets = ({ clientX, clientY }: { clientX: number;  clientY: number }) => ({
...
const ScrollHtml = React.forwardRef(
  ({ children, style, ...props }: { children?: React.ReactNode; style?: React.StyleHTMLAttributes<unknown> }, ref) => {
    const state = useScroll();
